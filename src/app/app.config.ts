...
const hostApi = process.env.NODE_ENV === 'development' ? 'http://localhost' : 'hhttp://localhost';
const portApi = process.env.NODE_ENV === 'development' ? 5001 : 5001;
const identityServer = process.env.NODE_ENV === 'development' ? 'http://localhost:5000' : 'http://localhost:5000';
const baseURLApi = `${hostApi}${portApi ? `:${portApi}` : ``}/api`;
const appUrl = 'http://localhost:3000';
const resourcesUrl = `${hostApi}${portApi ? `:${portApi}` : ``}/resources`;
